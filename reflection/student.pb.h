...
#if LANG_CXX11
inline void Student::set_course(::std::string&& value) {
...
#endif
inline void Student::set_course(const char* value) {
...
inline void Student::set_course(const char* value, size_t size) {
...
inline ::std::string* Student::mutable_course() {
...
inline ::std::string* Student::release_course() {
...
inline void Student::set_allocated_course(::std::string* course) {
  if (course != NULL) {
